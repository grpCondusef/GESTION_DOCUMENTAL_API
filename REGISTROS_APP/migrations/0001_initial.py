    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_sepomex', models.CharField(max_length=110, verbose_name='Número de SEPOMEX')),
                ...
                ('peso', models.FloatField(max_length=110, verbose_name='Peso')),
                ('costo', models.FloatField(max_length=110, verbose_name='Costo')),
                ('folio_diario', models.FloatField(max_length=110, verbose_name='Folio Diario')),
                ('acuse', models.FileField(upload_to='uploads/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Creado el')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Editado el')),
                ('registro', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='REGISTROS_APP.registrostable', verbose_name='Registro')),
            ],
            options={
